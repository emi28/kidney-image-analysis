...
%              the figure
                   ...
                   norm_x_1 = mid_x_test-mid_x_test; %x-coordinate of the cyan endpoint (NOTE: 10 is just an arbitrary value)
...
%                                hold on 
                               ...
                               hold on    
%                    elseif norm_x_1>0&&norm_y_1==0||norm_y_2==512&&norm_x_2>512;
%                                plot([x_first,x_next],[y_first,y_next],'r') %plots the red line segment connecting the two points
%                                hold on
%                                plot([mid_x_test,((-intercept)/(new_m))],[mid_y_test,0],'c','LineWidth',1) %plots the cyan line
% %                                hold on
...
% %                                hold on
%                                plot(mid_x_test,mid_y_test, 'o') %plots a circle at the midpoint
%                                plot(((-interept)/(new_m)), 0, 'o', 'Color','g'); %green endpoint of the cyan line
% %                                hold on 
%                                plot(512, ((512-intercept)/(new_m)), 'o', 'Color', 'm'); %magenta endpoint of the dark blue line
%                                hold on  
...
%                         if norm_y_1<0||norm_y_1<0&&norm_y_2>line_limit; %norm_y_2<0;
% %                              new_norm_y_1 == line_limit;
% %                              new_norm_x_1 == (line_limit-intercept)/(new_slope);
% %                              norm_y_1 == new_norm_y_1_A;
% %                              norm_x_1 == new_norm_x_1_A;
% %                              
%                               plot([x_first,x_next],[y_first,y_next],'r') %plots the red line segment connecting the two points
%                                hold on
%                                plot([mid_x_test,((-intercept)/new_m)],[mid_y_test,0],'c','LineWidth',1) %plots the cyan line
...
%                                hold on   
%   
%                          elseif norm_y_1>512||norm_y_2<0||norm_y_1>512&&norm_y_2<0;
% %                              new_norm_y_1 == 0;
% %                              new_norm_x_1 == intercept;
% %                              norm_y_1 == new_norm_y_1_B;
% %                              norm_x_1 == new_norm_x_1_B;
%                              
%                               plot([x_first,x_next],[y_first,y_next],'r') %plots the red line segment connecting the two points
%                                hold on
%                                plot([mid_x_test,((512-intercept)/new_m)],[mid_y_test,512],'c','LineWidth',1) %plots the cyan line
%                                plot([mid_x_test,((-intercept)/new_m)],[mid_y_test,0],'b','LineWidth',1) %plots the dark blue line
%                                plot(mid_x_test,mid_y_test, 'o') %plots a circle at the midpoint
%                                plot(((512-intercept)/new_m), 512, 'o', 'Color','g'); %green endpoint of the cyan line
%                                plot(((-intercept)/new_m), 0, 'o', 'Color', 'm'); %magenta endpoint of the dark blue line
%                                hold on   
%                         elseif norm_y_2>512||norm_y_1<0||norm_y_2>512&&norm_y_1<0;
%                             plot([x_first,x_next],[y_first,y_next],'r') %plots the red line segment connecting the two points
%                                hold on
%                                plot([mid_x_test,((-intercept)/new_m)],[mid_y_test,0],'c','LineWidth',1) %plots the cyan line
%                                plot([mid_x_test,((512-intercept)/new_m)],[mid_y_test,512],'b','LineWidth',1) %plots the dark blue line
...
%                                hold on
%                                
% %                         elseif norm_y_1>512||norm_y_2>512||norm_y_2>512&&norm_y_1>512
%                             
%                         else 
%                               plot([x_first,x_next],[y_first,y_next],'r') %plots the red line segment connecting the two points
%                                hold on
...
%                                hold on   
%                              %no changes are made to the perpendicualr line
%                              %endpoint coordinates
%                          end 
%                    norm_y_2 = (new_m)*(norm_x_2)+intercept; %y-coordinate of the dark blue endpoint using equation of perpendicular line 
%                          if norm_y_2>line_limit;
% %                              new_norm_y_2 == line_limit;
% %                              new_norm_x_2 == (line_limit-intercept)/(new_slope);
%                              norm_y_2 == new_norm_y_2_A;
%                              norm_x_2 == new_norm_x_2_A;
%                              
%                               plot([x_first,x_next],[y_first,y_next],'r') %plots the red line segment connecting the two points
%                                hold on
%                                plot([mid_x_test,norm_x_1],[mid_y_test,norm_y_1],'c','LineWidth',1) %plots the cyan line
...
%                          elseif norm_y_2<0;
% %                              new_norm_y_2 == 0;
% %                              new_norm_x_2 == intercept;
%                              norm_y_2 == new_norm_y_2_B;
%                              norm_x_2 == new_norm_x_2_B;
%                              
%                               plot([x_first,x_next],[y_first,y_next],'r') %plots the red line segment connecting the two points
%                                hold on
%                                plot([mid_x_test,norm_x_1],[mid_y_test,norm_y_1],'c','LineWidth',1) %plots the cyan line
...
% %                                hold on
% %                                plot([mid_x_test,norm_x_1],[mid_y_test,norm_y_1],'c','LineWidth',1) %plots the cyan line
% %                                plot([mid_x_test,norm_x_2],[mid_y_test,norm_y_2],'b','LineWidth',1) %plots the daine
% %                                plot(mid_x_test,mid_y_test, 'o') %plots a circle at the midpoint
% %                                plot(norm_x_1, norm_y_1, 'o', 'Color','g'); %green endpoint of the cyan line
% %                                plot(norm_x_2, norm_y_2, 'o', 'Color', 'm'); %magenta endpoint of the dark blue line
% %                                hold on   
